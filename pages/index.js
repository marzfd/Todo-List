        ...
        <div className='mb-3'>
          ...
          <Link href='/signIn'>
            <a>
              <button
                type='button'
                className='bg-purple-700 hover:bg-purple-500 transition duration-300 text-white md:font-semibold font-caveat lg:text-xl py-2 px-4 rounded-lg shadow-lg shadow-purple-500/50 focus:outline-none'
              >
                Let&apos;s Start
              </button>
            </a>
